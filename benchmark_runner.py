...
def main():
    ...
    inversion_images_folder_path = os.path.join(os.getcwd(), 'tests_datasets/inversion/stimuliLabMtcnn/')
    ...
    sim_international_images_folder_path = os.path.join(os.getcwd(), 'tests_datasets/similarity_perception_international_celebs/intFacesLabMtcnn')
    ...
    sim_il_images_folder_path = os.path.join(os.getcwd(), 'tests_datasets/similarity_perception_israeli_celebs/newIsraeliFacesStimuliLabMtcnn')
    ...
    other_race_images_folder_path = os.path.join(os.getcwd(), 'tests_datasets/other_race/other_raceLabMtcnn')
    ...
    thatcher_images_folder_path = os.path.join(os.getcwd(), 'tests_datasets/thatcher/images_thatcher_mtcnn')
    ...
    conditioned_images_folder_path = os.path.join(os.getcwd(), 'tests_datasets/critical_features/img_dataset/joined')
    ...
    #     distance_function = batch_cosine_distance,
    #     normalize = False,
    #     task_name = 'Critical Features - Not Normalized'
    #     )
